...
namespace System.Security.Policy {
    public class UrlMembershipCondition: System.Security.Policy.IMembershipCondition {

        public string Url { get; set; }
        public UrlMembershipCondition( string url )  {
			Bridge.Luna.Utils.Debug.WarnNotImplementedMethod(nameof(UrlMembershipCondition), typeof(String));
            }
        ...
        internal void CheckUrl( string url ) {
			Bridge.Luna.Utils.Debug.WarnNotImplementedMethod(nameof(CheckUrl), typeof(String) );
		}
    }
}