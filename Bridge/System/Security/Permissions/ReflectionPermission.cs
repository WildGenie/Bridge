...
namespace System.Security.Permissions {
    public class ReflectionPermission: System.Security.CodeAccessPermission, System.Security.Permissions.IUnrestrictedPermission {
        ...
        public ReflectionPermission( System.Security.Permissions.PermissionState state )  {
			Bridge.Luna.Utils.Debug.WarnNotImplementedMethod(nameof(ReflectionPermission), typeof(PermissionState));
            }
        public ReflectionPermission( System.Security.Permissions.ReflectionPermissionFlag flag )  {
			Bridge.Luna.Utils.Debug.WarnNotImplementedMethod(nameof(ReflectionPermission), typeof(ReflectionPermissionFlag));
            }
