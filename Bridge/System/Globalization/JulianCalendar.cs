...
namespace System.Globalization {
    public class JulianCalendar: System.Globalization.Calendar {
        ...
        internal void CheckYearEraRange( int year, int era ) {
			Bridge.Luna.Utils.Debug.WarnNotImplementedMethod(nameof(CheckYearEraRange), typeof(Int32), typeof(Int32) );
		}
        internal static void CheckMonthRange( int month ) {
			Bridge.Luna.Utils.Debug.WarnNotImplementedMethod(nameof(CheckMonthRange), typeof(Int32) );
		}
        internal static void CheckDayRange( int year, int month, int day ) {
			Bridge.Luna.Utils.Debug.WarnNotImplementedMethod(nameof(CheckDayRange), typeof(Int32), typeof(Int32), typeof(Int32) );
		}
