...
namespace System.Globalization {
    public class JapaneseCalendar: System.Globalization.Calendar {
        ...
        internal static string[][] EraNames() {
			Bridge.Luna.Utils.Debug.WarnNotImplementedMethod(nameof(EraNames) );
            return default( string[][] );

		}
        internal static string[][] AbbrevEraNames() {
			Bridge.Luna.Utils.Debug.WarnNotImplementedMethod(nameof(AbbrevEraNames) );
            return default( string[][] );

		}
        internal static string[][] EnglishEraNames() {
			Bridge.Luna.Utils.Debug.WarnNotImplementedMethod(nameof(EnglishEraNames) );
            return default( string[][] );

		}
        internal override bool IsValidYear( int year, int era ) {
			Bridge.Luna.Utils.Debug.WarnNotImplementedMethod(nameof(IsValidYear), typeof(Int32), typeof(Int32) );
            return default( bool );
